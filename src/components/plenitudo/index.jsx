  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 antialiased relative overflow-hidden">
      ...
      <style>{`
        ...
        .btn-ghost { display:inline-flex; align-items:center; gap:.5rem; padding:.5rem .625rem; border-radius:.75rem; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.08); min-height: 44px; font-size: .875rem; }
