...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Plena - a meditation tracking application. Learn how we collect, use, and protect your health data through Apple's HealthKit framework.",
};
        ...
        <div className="prose prose-invert prose-slate max-w-none mb-12">
          <div className="space-y-8 text-sm sm:text-base text-slate-300 leading-relaxed">
            ...
            <section>
              ...
              <p>
                Plena ("we," "our," or "us") is committed to protecting your
                privacy. This Privacy Policy explains how we collect, use,
                disclose, and safeguard your information when you use our
                meditation tracking application ("App") and related services.
              </p>
              <p className="mt-3">
                <strong>Data Controller:</strong> Plena (Plenitudo.ai) acts as
                the data controller for personal data processed within the app.
              </p>
            ...
            <section>
              ...
              <p>
                Plena accesses the following health data types through Apple's
                HealthKit framework:
              </p>
              ...
              <div className="mt-3">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  ...
                  <li>Estimated VO₂ Max (Apple Fitness estimates)</li>
                </ul>
              </div>
              ...
              <div className="mt-3">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>Meditation session data (mindfulness sessions)</li>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                ...
                <li>App version</li>
                <li>
                  Anonymous device identifiers generated by the operating system
                  (used solely for app functionality, not tracking or
                  advertising)
                </li>
              </ul>
              <p className="mt-2 text-slate-400 italic">
                <strong>Note:</strong> We do not use advertising identifiers
                (IDFA) or any tracking identifiers.
              </p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>
                  <strong>Local Storage:</strong> Data is protected by iOS
                  system-level encryption and your device's security features
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                ...
                <li>
                  In emergency situations to protect health or safety (note:
                  since Plena does not transmit health data to our servers, any
                  such disclosure would only apply to non-health information if
                  legally required)
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>We read biometric data during meditation sessions</li>
                <li>We write meditation session data back to HealthKit</li>
                ...
                <li>
                  <strong>
                    Health data obtained through HealthKit is not used for
                    advertising, marketing, or tracking, and is not shared with
                    analytics services
                  </strong>
                </li>
              </ul>
            ...
            <section>
              ...
              <p>
                We process health data based on your explicit consent, which you
                grant through Apple HealthKit permissions. You may withdraw
                consent at any time through iOS settings. This consent is the
                lawful basis for processing your health data under GDPR Article
                6(1)(a).
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3 text-emerald-300">
                ...
                privacy in mind. Your health data is yours, and we're just here
